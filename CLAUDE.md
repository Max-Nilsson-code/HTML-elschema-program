...
- Pins must land on the 20-unit grid. Control-circuit symbols are 80×80; main-circuit ones are 160×80 (three poles at x=60/100/140, left column free for designation and actuator), 160×160 (kontaktor med motorskydd) and 160×160 / 160×200 (motor, leads on the same x as the poles). Symbols 16–21 are extracted from `Symboler3Fas.svg`. Keep width and height multiples of 40: rotation is about the symbol centre, so other sizes push rotated pins off-grid.
